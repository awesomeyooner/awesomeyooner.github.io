...
class GameManager{
    ...
    update(){
        ...
        GridManager.getInstance().update(this.player.barricadeManager.getProjectiles(), 50, false);
        EnemyManager.getInstance().update(this.playerFortress, this.enemyFortress, false);
